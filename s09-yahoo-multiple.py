...
all_tickers = ['BTC-USD', 'ETH-USD', 'BNB-USD', 'ADA-USD', 'SOL1-USD', 'XRP-USD',
              'DOT1-USD', 'DOGE-USD', 'LUNA1-USD', 'UNI3-USD', 'AVAX-USD', 
              'LINK-USD', 'LTC-USD', 'ALGO-USD']
...
close_prices.to_csv('output/09_crypto.csv')

xrp = close_prices['XRP-USD']
xrp.plot()
plt.title('XRP')
plt.ylabel('Price ($)')
plt.show()